...
let customers = [
    {
        id: 1,
        name: "Najeeb Shekasan",
        phone: "+974 30544808",
        email: "najeeb@gmail.com",
        stage: "new",
        temp: "hot",
        channel: "WhatsApp",
        notes: "Interested in a full commercial MEP maintenance contract for West Bay Doha office tower. Needs AC repair and inspection scheduled.",
        labels: ["MEP Project"],
        loyaltyPoints: 120,
        dateAdded: "2026-06-07",
        lastContact: "16:41",
        messages: [
            { sender: "incoming", text: "Hello, I saw your brochure for Smart Vision CRM and MEP operations. I need an urgent maintenance quote for our commercial building.", time: "16:40" },
            { sender: "outgoing", text: "Hello Najeeb! Thanks for reaching out. Yes, we provide full MEP service contracts. To give you an accurate quote, could you please tell us the location and approximate size of your building?", time: "16:41" },
            { sender: "incoming", text: "It's in West Bay, Doha. It's a 15-story office tower. Do you also provide AC repair?", time: "16:41" }
        ],
        aiSuggestion: "Yes, Najeeb! We offer comprehensive AC maintenance and repair as part of our MEP package. Our team in Doha is ready to inspect. Can we schedule an inspection tomorrow at 10 AM?",
        score: 85,
        history: [
            { type: "system", text: "Profile created from WhatsApp Enquiry", time: "2026-06-07 14:00" },
            { type: "system", text: "WhatsApp live chat session opened", time: "2026-06-07 16:40" }
        ]
    },
    {
        id: 2,
        ...
        temp: "warm",
        channel: "Email",
        notes: "Inquired about HomeSales interior paint packages.",
        labels: ["HomeSales Paint"],
        loyaltyPoints: 50,
        ...
        score: 72,
        history: [
            { type: "system", text: "Enquiry email received regarding paint packages", time: "2026-06-06 11:20" }
        ]
    },
    {
        id: 3,
        ...
        temp: "cold",
        channel: "WhatsApp",
        notes: "Followed up on HVAC supplier quotation. Sent Whatsapp.",
        labels: ["HVAC Supply"],
        loyaltyPoints: 10,
        ...
        score: 40,
        history: [
            { type: "system", text: "HVAC Supplier Quotation generated", time: "2026-06-05 09:30" },
            { type: "system", text: "Sent WhatsApp reminder", time: "2026-06-07 10:15" }
        ]
    },
    {
        id: 4,
        ...
        phone: "+974 77123456",
        email: "abdulla.althani@outlook.com",
        stage: "qualified",
        temp: "hot",
        channel: "AI Chatbot",
        notes: "Qualified by bot. Budget: QR 12,000. Needs AC replacement.",
        labels: ["AC Replacement"],
        loyaltyPoints: 150,
        dateAdded: "2026-06-07",
        lastContact: "15:20",
        messages: [
            { sender: "incoming", text: "Can you replace the split AC units?", time: "15:18" },
            { sender: "outgoing", text: "Yes Abdulla, we do AC unit replacements! What size is your AC unit (in tons) or what is the room size?", time: "15:19" },
            { sender: "incoming", text: "It's a 2-ton split AC in the living room.", time: "15:20" }
        ],
        aiSuggestion: "Perfect. A 2-ton split AC installation typically costs around QR 3,500 including the unit. Would you like me to book our technician for a home survey?",
        score: 78,
        history: [
            { type: "system", text: "AI Bot qualification sequence started", time: "2026-06-07 15:00" },
            { type: "system", text: "AI Qualified - Budget: QR 12,000", time: "2026-06-07 15:20" }
        ]
    },
    {
        id: 5,
        name: "Yasmin Rahmani",
        phone: "+974 66098765",
        email: "yasmin@doha-mail.com",
        stage: "proposal",
        temp: "warm",
        channel: "Doc Sent",
        notes: "Sent quotation for full villa electrical rewiring.",
        ...
        score: 70,
        history: [
            { type: "system", text: "Quotation draft generated for villa rewiring", time: "2026-06-04 15:30" },
            { type: "system", text: "Quotation INV-2026-003 sent via email", time: "2026-06-04 16:00" }
        ]
    },
    {
        id: 6,
        name: "Ali Hassan",
        phone: "+974 33445566",
        email: "ali.hassan@doha-mail.com",
        stage: "won",
        temp: "hot",
        channel: "Completed",
        notes: "Contract signed. Deposit invoice #INV-2026-004 paid.",
        labels: ["Full Contract"],
        loyaltyPoints: 300,
        dateAdded: "2026-06-05",
        lastContact: "13:45",
        messages: [],
        ...
        score: 100,
        history: [
            { type: "system", text: "Contract draft signed by client", time: "2026-06-05 10:00" },
            { type: "system", text: "Deposit invoice INV-2026-004 generated", time: "2026-06-07 13:30" },
            { type: "system", text: "Deposit payment QR 5,800 received", time: "2026-06-07 13:45" }
        ]
    }
];
